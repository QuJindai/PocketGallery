...
void main() {
  test(
    'trace vector sample uses captured query then active and shadow hits',
    () async {
      ...
      for (final documentId
          in chunks.map((chunk) => chunk.documentId).toSet()) {
      ...
      expect(result.queryVectorSha256, snapshot.queryEmbedding!.vectorSha256);
