...
class TraceComparison {
  ...
  factory TraceComparison.between(
    ...
    return TraceComparison(
      candidateDelta:
          comparison.candidates.length - baseline.candidates.length,
      ...
      knownDurationDeltaUs:
          knownDuration(comparison) - knownDuration(baseline),
    );
  }
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (!rerunEnabled)
                const Text('当前入口没有聊天运行器；可查看与导出，但不能重跑。'),
            ],
          ),
        ),
      );
