...
void main() {
  test(
    'private upgrade snapshots detect loss and expose only aggregates',
    () async {
      ...
      final oauth = HfOAuthDeviceService(
        ...
        client: MockClient((request) async {
          throw StateError(
            'preservation capture must not use HTTP: ${request.url}',
          );
        }),
      ...
      final session = await chatStore.createSession(
