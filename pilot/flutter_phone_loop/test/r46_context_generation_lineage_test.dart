...
void main() {
  test(
    'context decision accounts for the actual selected history, evidence and query',
    () {
      ...
      expect(
        decision.trimmedHistoryMessages,
  ...
  test('streamed text tokens produce measured generation telemetry', () {
    ...
    expect(result.telemetry.sessionResetReason, 'fresh_turn_context_bound');
  });
