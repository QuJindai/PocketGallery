...
void main() {
  test(
    'R4.6-C strategy registry freezes active control and shadow variants',
    () {
      expect(
      ...
      expect(heading.representations, {
      ...
      final sentence = RetrievalStrategies.byId('shadow.sentence-parent-child');
