...
void main() {
  test('ACTIVE health requires persisted body vectors, commit and real search',
      () async {
    ...
    await lineage.putEmbedding(LineageEmbedding.test(
      embeddingId: bodyId,
      sourceKind: 'chunk',
      sourceId: 'c1',
      documentId: 'd1',
    ...
    await lineage.putVectorIndexEntry(VectorIndexEntryRecord(
    ...
    expect((await service.snapshot()).ready, isTrue,
        reason: 'SHADOW representations never gate ACTIVE readiness');
  });

  test('Chunk Explorer separates legacy observations from R4.6 ACTIVE health',
      () async {
