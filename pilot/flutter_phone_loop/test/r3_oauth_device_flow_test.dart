...
void main() {
  test('R3 replaces pasted Hugging Face token with OAuth Device Code flow', () async {
  ...
  test('R3 model setup consumes OAuth access token without exposing it in UI', () async {
