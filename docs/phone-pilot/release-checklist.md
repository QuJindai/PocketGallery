...
2. The complete Flutter regression suite passes, including all R4.6 B/C tests.
...
10. The APK package is `com.qujindai.pocketgallery_phone_pilot.r3`.
11. The APK version is `0.4.17` with Android versionCode `2020` or higher.
12. Native libraries contain only `arm64-v8a`.
13. The APK signer certificate SHA-256 is exactly `81af4a5ef94c236774f0e193b2a4b248805b36c14cc36e2a56df8e451a712541`.
14. The downloaded APK digest matches its Actions-produced SHA-256 sidecar.
