...
void main() {
  test(
    'generation summary exposes measured stream metrics and honest backend',
    () {
  ...
  test(
    'microscope teaches identities and is reachable from chat and knowledge',
    () async {
