...
void main() {
  test(
    'heading and sentence hits preserve their parent chunk identity',
    () async {
      ...
      const chunk = PgChunk(
        ...
        ordinal: 0,
        text:
            '第一条说明足够长用于切句。第二条说明足够长用于切句。第三条说明足够长用于切句。'
      ...
      expect(
        sentences
            .map((embedding) => '${embedding.spanStart}:${embedding.spanEnd}')
            .toSet(),
        hasLength(4),
      );
