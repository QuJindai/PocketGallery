...
void main() {
  test(
    'trace snapshot uses the persisted query vector and resolves all facts',
    () async {
  ...
  test(
    'redacted report is deterministic and excludes raw vectors and secrets',
    () async {
      final db = sqlite3.openInMemory();
      addTearDown(db.close);
      final store = LineageStore(database: db);
