...
void main() {
    ...
    await lexical.replaceDocument(ImportedDocument(
      ...
      chunks: List.generate(
        ...
        (i) => PgChunk(
          ...
          locator: 'p${i + 1}',
          ordinal: i,
          text: 'Transformer architecture attention encoder decoder section $i',
        ),
      ),
    ));
    await lexical.replaceDocument(ImportedDocument(
      ...
      chunks: List.generate(
        ...
        (i) => PgChunk(
          ...
          locator: 'p${i + 1}',
          ordinal: i,
          text: 'Resilient positioning navigation timing best practice section $i',
        ),
      ),
    ));
  ...
  test('R4.0.1 resumes download after returning from license page without new OAuth', () {
    ...
    expect(settings, contains('modelState.phase == ModelSetupPhase.licenseRequired'));
