...
void main() {
  test(
    'R4.0.1 corpus summary gets cross-document evidence without embedding',
    () async {
  ...
  test(
    'R4.0.1 resumes download after returning from license page without new OAuth',
    () {
      final settings = File(
        'lib/ui/model_settings_page.dart',
      ).readAsStringSync();
