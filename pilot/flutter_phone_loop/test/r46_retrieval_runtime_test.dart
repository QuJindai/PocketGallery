...
void main() {
  test('active retrieval executes FTS, one query embedding, vector search, fusion and lineage', () async {
    ...
    final persistedQuery = await store.embeddingById(bundle.queryEmbeddingId!);
