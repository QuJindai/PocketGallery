...
void main() {
  testWidgets(
    'experiment detail compares lanes and drills into filtered rows',
    (tester) async {
      ...
      expect(
        find.textContaining('failure after persisted candidates'),
        findsOneWidget,
      );
      ...
      final candidatesButton = find.byKey(
        const ValueKey<String>('experiment-candidates'),
      );
      await tester.ensureVisible(candidatesButton);
      await tester.tap(candidatesButton);
      await tester.pumpAndSettle();
      expect(
        find.byKey(const ValueKey<String>('candidate-pool-page')),
        findsOneWidget,
      );
