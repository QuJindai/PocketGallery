...
void main() {
  testWidgets(
    'decision pages expose captured ranks router budget and citation',
    (tester) async {
      ...
      expect(
        find.textContaining('Citation → Evidence → Chunk'),
        findsOneWidget,
      );
      ...
      await pump(
        EmbeddingMicroscopePage(engine: data.engine, snapshot: data.snapshot),
      );
